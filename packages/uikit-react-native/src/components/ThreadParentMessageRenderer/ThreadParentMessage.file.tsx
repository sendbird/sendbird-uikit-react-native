...
import { Box, createStyleSheet, PressBox, Icon, Text } from '@sendbird/uikit-react-native-foundation';
...
const ThreadParentMessageFile = (props: ThreadParentMessageRendererProps) => {
  ...
  return (
    <Box style={styles.fileBubbleContainer} backgroundColor={select({ light: palette.background100, dark: palette.background400 })}>
