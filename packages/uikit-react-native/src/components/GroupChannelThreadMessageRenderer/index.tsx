...
import type { GroupChannelThreadProps } from '../../domain/groupChannelThread/types';
import { useLocalization, usePlatformService, useSendbirdChat } from '../../hooks/useContext';
import SBUUtils from '../../libs/SBUUtils';
import { ReactionAddons } from '../ReactionAddons';
import GroupChannelMessageDateSeparator from '../GroupChannelMessageRenderer/GroupChannelMessageDateSeparator';
import GroupChannelMessageFocusAnimation from '../GroupChannelMessageRenderer/GroupChannelMessageFocusAnimation';
import GroupChannelMessageOutgoingStatus from '../GroupChannelMessageRenderer/GroupChannelMessageOutgoingStatus';

const GroupChannelThreadMessageRenderer: GroupChannelThreadProps['Fragment']['renderMessage'] = ({
  channel,
  message,
  onPress,
  onLongPress,
...
export default React.memo(GroupChannelThreadMessageRenderer);
