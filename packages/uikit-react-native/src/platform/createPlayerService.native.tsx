...
export type AudioPlayerModule = typeof AudioRecorderPlayerModule | typeof NitroSoundModule;
...
class NitroSoundAdapter implements PlayerModuleAdapter {
...
function isNitroSoundModule(module: AudioPlayerModule): module is typeof NitroSoundModule {
